"""
Patched copy of guidance.models._googleai.py

NOTE: PATCHES
1.  Removed assertion at line 178
    Reason:
    To allow consecutive assistant() roles. Sometimes, it causes the exhaustion of
    maximum number of attempts for grammar execution. In practice, if the last assistant
    role has clear intentions about the next assistant role which is actually generated
    by the model then it is safe to remove the assertion.
"""
